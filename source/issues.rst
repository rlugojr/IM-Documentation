...
* ImagicalMine version
* PHP binary version
* Plugin versions


When you have the latest version of those files, and the problem still occurs, making certain that a **plugin** is not the cause, then `make a new issue <https://github.com/ImagicalCorp/ImagicalMine/issues/new>`_ on GitHub.
